...
Usage:
  ...
  python tools/cloudflare_secure_baseline.py --apply --zone trycaprock.com
            ...
            if apply:
                try:
                    create_dns_record(zone_id, {
                        "type": "TXT", "name": "@",
                        "content": '"v=spf1 -all"',
                        "comment": "Caprock baseline: no senders authorized",
                    }, token)
            ...
            if apply:
                try:
                    create_dns_record(zone_id, {
                        ...
                        "comment": "Caprock baseline: reject spoofed mail",
                    }, token)
